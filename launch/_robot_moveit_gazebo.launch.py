...
def launch_setup(context, *args, **kwargs):
    ...
    robot_gazebo_launch = IncludeLaunchDescription(
    	...
    	#changed to point at launch file in valm package
        PythonLaunchDescriptionSource(PathJoinSubstitution([ThisLaunchFileDir(), '_robot_beside_table_gazebo.launch.py'])),
